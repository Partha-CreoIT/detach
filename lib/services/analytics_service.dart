...
class AnalyticsService extends GetxService {
  ...
  Future<void> _initializeAnalytics() async {
    try {
      ...
      log('Firebase Analytics Observer created');
  ...
  Future<void> logEvent({
    ...
    try {
      log(
        'Attempting to log Firebase event: $name with parameters: $parameters',
      );

      if (_firebaseAnalytics == null) {
        log('Firebase Analytics is null! Cannot log event.');
        print('Firebase Analytics is null! Cannot log event.');
        return;
      }

      // Check if Firebase is properly initialized
      log('Firebase Analytics instance: $_firebaseAnalytics');
      print('Firebase Analytics instance: $_firebaseAnalytics');

      await _firebaseAnalytics!.logEvent(name: name, parameters: parameters);

      if (kDebugMode) {
        log(
          'Firebase Analytics Event logged successfully: $name with parameters: $parameters',
        );
        print(
          'Firebase Analytics Event logged successfully: $name with parameters: $parameters',
        );
      ...
      log('Error logging Firebase event: $e');
